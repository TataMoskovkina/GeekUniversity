...
new_list = [random.randint(0, 200) for i in range(100)]
...
на массиве в 1000 элементов пузырьковая сортировка - 5.434051430635009 оказалась наименее быстрой и
проиграла сортировке выбором - 4.990473746849602 почти пол секунды.

если сравнить пузырьковую сортировку и сортировку вставками по времени выполнения, 
то разница колоссальная, конечно. Я не поленилась и посчитала :) Разница в 202 раза.
"""        
