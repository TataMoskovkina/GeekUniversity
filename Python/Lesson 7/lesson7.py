# -*- coding: utf-8 -*-
"""
Created on Tue Nov 20 01:22:33 2018
...
game_set = random.sample(range(1,91), 30)
p1_set = random.sample(game_set, 15)
p2_set = random.sample(game_set, 15)
...
for p1line in p1_field:
    ...
    p1line.insert(random.randint(0, 8), ' ')
    p1line.insert(random.randint(0, 9), ' ')
